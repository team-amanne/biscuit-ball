	...
	<div class="main container-fluid">
		...
		<div class="row">
			<div class="col-md-2"></div>
				<div class="col-md-8">
					<div class="col-md-6">
						<div class="panel panel-default col-party" style="opacity: 0.6; background-size: cover; background-image: url('../../Play_image/baNong.jpg');">
					...
					<div class="col-md-6">
						<div class="panel panel-default col-party" style="opacity: 0.6; background-size: cover; background-image: url('../../Play_image/hamNong.jpg');">
							<div class="panel-body">
